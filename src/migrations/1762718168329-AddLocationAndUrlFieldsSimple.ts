...
export class AddLocationAndUrlFieldsSimple1762718168329
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "quizzes" ADD COLUMN IF NOT EXISTS "normalUrl" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "quizzes" ADD COLUMN IF NOT EXISTS "shortUrl" character varying`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "quizzes" DROP COLUMN IF EXISTS "shortUrl"`,
    );
    await queryRunner.query(
      `ALTER TABLE "quizzes" DROP COLUMN IF EXISTS "normalUrl"`,
    );
